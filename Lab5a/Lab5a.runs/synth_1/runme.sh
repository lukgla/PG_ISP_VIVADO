...
HD_PWD='C:/Users/lukgla/Desktop/Vivado/Lab5a/Lab5a.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab5a_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab5a_top.tcl
