...
#
# Script generated by Vivado on Tue Mar 19 23:21:32 +0100 2024
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_mem xil_defaultlib.fifo_mem xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/Vivado/2023.2/data/xsim"
  fi
